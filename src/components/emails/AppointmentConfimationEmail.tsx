...
function AppointmentConfimationEmail({
  appointmentDate,
  appointmentTime,
  appointmentType,
  doctorName,
  ...
  return (
    <Html>
      <Head />
      <Preview>Your detal appointment has been confirmed</Preview>

      <Body style={main}>
        <Container style={container}>
          <Section style={logoContainer}>
            <Img
              src="https://i.ibb.co/dsvzRhHz/logo.png"
              width="50"
              height="50"
              alt="DentWise"
              style={logo}
...
export default AppointmentConfimationEmail;
